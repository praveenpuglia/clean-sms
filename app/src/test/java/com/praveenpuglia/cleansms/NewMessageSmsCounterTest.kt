...
class NewMessageSmsCounterTest {
    ...
    fun countsGsmAndUnicodeBoundaries() {
        listOf(
            "" to SmsCounter("0 / 160"),
            "a".repeat(144) to SmsCounter("144 / 160"),
            "a".repeat(145) to SmsCounter("145 / 160", nearLimit = true),
            "a".repeat(160) to SmsCounter("160 / 160", nearLimit = true),
            "a".repeat(161) to SmsCounter("145", "2 SMS"),
            "a".repeat(306) to SmsCounter("0", "2 SMS"),
            "a".repeat(307) to SmsCounter("152", "3 SMS"),
            "₹".repeat(70) to SmsCounter("70 / 70", nearLimit = true),
            "₹".repeat(71) to SmsCounter("63", "2 SMS"),
            "₹".repeat(134) to SmsCounter("0", "2 SMS"),
            "₹".repeat(135) to SmsCounter("66", "3 SMS"),
